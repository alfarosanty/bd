...
public class PresupuestoServices : IPresupuestoService{
    ...
    public PresupuestoServices(IPresupuestoRepository _iPresupuestoRepository){
        iPresupuestoRepository = _iPresupuestoRepository;
    }

    public Task<Presupuesto?> GetPresupuestoAsync(int idPresupuesto)
    {
    ...
    {
        var idPresupuesto = await iPresupuestoRepository.CrearPresupuestoAsync(presupuesto);

        foreach (var articulo in presupuesto.Articulos)
        {
            articulo.IdPresupuesto = idPresupuesto;
            await iPresupuestoRepository.AgregarArticuloPresupuestoAsync(articulo);
        }
